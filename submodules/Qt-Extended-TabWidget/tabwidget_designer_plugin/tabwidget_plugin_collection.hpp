...
class Extended_Tabwidget_Plugin_Collection : public QObject, public QDesignerCustomWidgetCollectionInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "mattia.basaglia.Extended_Tabwidget_Plugin")
    Q_INTERFACES(QDesignerCustomWidgetCollectionInterface)

public:
    explicit Extended_Tabwidget_Plugin_Collection(QObject *parent = 0);
